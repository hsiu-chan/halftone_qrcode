...
#'C:\Users\Hamed\Desktop\Halftoning\halftone algorithm\val_256\val_256\Places365_val_00004267.jpg'
img=Image.open('/data/Places365_val_00000002.jpg')
imgplot = plt.imshow(generate_halftone(img))
plt.show()
